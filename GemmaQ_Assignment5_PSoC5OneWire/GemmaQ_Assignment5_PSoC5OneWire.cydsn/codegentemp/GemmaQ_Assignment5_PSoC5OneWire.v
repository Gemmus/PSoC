// ======================================================================
// GemmaQ_Assignment5_PSoC5OneWire.v generated from TopDesign.cysch
// 04/01/2024 at 17:22
...
module top ;
    ...
    UART_v2_50_1 UART (
        ...
        .reset(1'b0),
        .rx(Net_191),
        .tx_interrupt(Net_192),
        .rx_interrupt(Net_193),
        .tx_data(Net_194),
        .tx_clk(Net_195),
        .rx_data(Net_196),
        .rx_clk(Net_197));
    ...
    defparam ADC_Timer.InterruptOnTC = 1;
    defparam ADC_Timer.Resolution = 24;
    ...
    Timer_v2_80_3 OneWire_Timer (
        ...
        .tc(Net_235),
        .clock(Net_227));
    defparam OneWire_Timer.CaptureCount = 2;
    defparam OneWire_Timer.CaptureCounterEnabled = 0;
    defparam OneWire_Timer.DeviceFamily = "PSoC5";
    defparam OneWire_Timer.InterruptOnCapture = 0;
    defparam OneWire_Timer.InterruptOnTC = 1;
    defparam OneWire_Timer.Resolution = 16;
    defparam OneWire_Timer.SiliconRevision = "0";
	...
	cy_clock_v1_0
		#(.id("962d0ae0-1ab0-4dc6-b380-eea85b811f16"),
		  .source_clock_id("75C2148C-3656-4d8a-846D-0CAE99AB6FF7"),
		  .divisor(0),
		  .period("0"),
		  .is_direct(1),
