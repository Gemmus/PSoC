...
*
* \funcusage
*  \snippet Pin25_SUT.c usage_Pin25_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Pin25_SUT.c usage_Pin25_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Pin25_SUT.c usage_Pin25_Read  
*******************************************************************************/
...
* preferred Pin25_Read() API because the 
* Pin25_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Pin25_SUT.c usage_Pin25_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Pin25_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Pin25_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Pin25_0_INTR       (First pin in the list)
    *  - Pin25_1_INTR       (Second pin in the list)
    *  - ...
    *  - Pin25_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Pin25_SUT.c usage_Pin25_SetInterruptMode
    *******************************************************************************/
    void Pin25_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Pin25_0_INTR) != 0u) 
		{ 
			 Pin25_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Pin25_SUT.c usage_Pin25_ClearInterrupt
    *******************************************************************************/
