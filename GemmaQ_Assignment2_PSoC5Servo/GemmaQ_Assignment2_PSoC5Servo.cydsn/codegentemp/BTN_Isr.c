...
void BTN_Isr_SetVector(cyisraddress address)
{
    ...
    ramVectorTable[CYINT_IRQ_BASE + (uint32)BTN_Isr__INTC_NUMBER] = address;
}
...
cyisraddress BTN_Isr_GetVector(void)
{
    ...
    return ramVectorTable[CYINT_IRQ_BASE + (uint32)BTN_Isr__INTC_NUMBER];
}
