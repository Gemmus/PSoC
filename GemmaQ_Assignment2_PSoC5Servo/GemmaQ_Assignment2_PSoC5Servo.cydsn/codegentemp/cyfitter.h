...
#define PWM_Isr__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define PWM_Isr__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define PWM_Isr__INTC_MASK 0x01u
#define PWM_Isr__INTC_NUMBER 0u
#define PWM_Isr__INTC_PRIOR_NUM 7u
#define PWM_Isr__INTC_PRIOR_REG CYREG_NVIC_PRI_0
#define PWM_Isr__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define PWM_Isr__INTC_SET_PD_REG CYREG_NVIC_SETPEND0
...
/* PWMOut */
#define PWMOut__0__INTTYPE CYREG_PICU2_INTTYPE0
#define PWMOut__0__MASK 0x01u
#define PWMOut__0__PC CYREG_PRT2_PC0
#define PWMOut__0__PORT 2u
#define PWMOut__0__SHIFT 0u
#define PWMOut__AG CYREG_PRT2_AG
#define PWMOut__AMUX CYREG_PRT2_AMUX
#define PWMOut__BIE CYREG_PRT2_BIE
#define PWMOut__BIT_MASK CYREG_PRT2_BIT_MASK
#define PWMOut__BYP CYREG_PRT2_BYP
#define PWMOut__CTL CYREG_PRT2_CTL
#define PWMOut__DM0 CYREG_PRT2_DM0
#define PWMOut__DM1 CYREG_PRT2_DM1
#define PWMOut__DM2 CYREG_PRT2_DM2
#define PWMOut__DR CYREG_PRT2_DR
#define PWMOut__INP_DIS CYREG_PRT2_INP_DIS
#define PWMOut__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU2_BASE
#define PWMOut__LCD_COM_SEG CYREG_PRT2_LCD_COM_SEG
#define PWMOut__LCD_EN CYREG_PRT2_LCD_EN
#define PWMOut__MASK 0x01u
#define PWMOut__PORT 2u
#define PWMOut__PRT CYREG_PRT2_PRT
#define PWMOut__PRTDSI__CAPS_SEL CYREG_PRT2_CAPS_SEL
#define PWMOut__PRTDSI__DBL_SYNC_IN CYREG_PRT2_DBL_SYNC_IN
#define PWMOut__PRTDSI__OE_SEL0 CYREG_PRT2_OE_SEL0
#define PWMOut__PRTDSI__OE_SEL1 CYREG_PRT2_OE_SEL1
#define PWMOut__PRTDSI__OUT_SEL0 CYREG_PRT2_OUT_SEL0
#define PWMOut__PRTDSI__OUT_SEL1 CYREG_PRT2_OUT_SEL1
#define PWMOut__PRTDSI__SYNC_OUT CYREG_PRT2_SYNC_OUT
#define PWMOut__PS CYREG_PRT2_PS
#define PWMOut__SHIFT 0u
#define PWMOut__SLW CYREG_PRT2_SLW

/* BTN_Isr */
#define BTN_Isr__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define BTN_Isr__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define BTN_Isr__INTC_MASK 0x40u
#define BTN_Isr__INTC_NUMBER 6u
#define BTN_Isr__INTC_PRIOR_NUM 7u
#define BTN_Isr__INTC_PRIOR_REG CYREG_NVIC_PRI_6
#define BTN_Isr__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define BTN_Isr__INTC_SET_PD_REG CYREG_NVIC_SETPEND0

/* Miscellaneous */
#define BCLK__BUS_CLK__HZ 24000000U
#define BCLK__BUS_CLK__KHZ 24000U
#define BCLK__BUS_CLK__MHZ 24U
#define CY_PROJECT_NAME "GemmaQ_Assignment2_PSoC5Servo"
