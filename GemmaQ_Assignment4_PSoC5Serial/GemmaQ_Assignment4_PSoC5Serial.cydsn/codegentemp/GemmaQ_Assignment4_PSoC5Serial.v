// ======================================================================
// GemmaQ_Assignment4_PSoC5Serial.v generated from TopDesign.cysch
// 03/31/2024 at 18:09
...
module top ;
	...
	wire [0:0] tmpOE__SPIM_SCLK_net;
	wire [0:0] tmpFB_0__SPIM_SCLK_net;
	wire [0:0] tmpIO_0__SPIM_SCLK_net;
	wire [0:0] tmpINTERRUPT_0__SPIM_SCLK_net;
	electrical [0:0] tmpSIOVREF__SPIM_SCLK_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		SPIM_SCLK
		 (.oe(tmpOE__SPIM_SCLK_net),
		  .y({Net_167}),
		  .fb({tmpFB_0__SPIM_SCLK_net[0:0]}),
		  .io({tmpIO_0__SPIM_SCLK_net[0:0]}),
		  .siovref(tmpSIOVREF__SPIM_SCLK_net),
		  .interrupt({tmpINTERRUPT_0__SPIM_SCLK_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SPIM_SCLK_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SPIM_SS_net;
	wire [0:0] tmpFB_0__SPIM_SS_net;
	wire [0:0] tmpIO_0__SPIM_SS_net;
	wire [0:0] tmpINTERRUPT_0__SPIM_SS_net;
	electrical [0:0] tmpSIOVREF__SPIM_SS_net;

	cy_psoc3_pins_v1_10
		#(.id("484d829a-1485-4be5-8fe5-ff88217bab08"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SPIM_SS
		 (.oe(tmpOE__SPIM_SS_net),
		  .y({Net_168}),
		  .fb({tmpFB_0__SPIM_SS_net[0:0]}),
		  .io({tmpIO_0__SPIM_SS_net[0:0]}),
		  .siovref(tmpSIOVREF__SPIM_SS_net),
		  .interrupt({tmpINTERRUPT_0__SPIM_SS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SPIM_SS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SPIM_MISO_net;
	wire [0:0] tmpIO_0__SPIM_MISO_net;
	wire [0:0] tmpINTERRUPT_0__SPIM_MISO_net;
	electrical [0:0] tmpSIOVREF__SPIM_MISO_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		SPIM_MISO
		 (.oe(tmpOE__SPIM_MISO_net),
		  .y({1'b0}),
		  .fb({Net_169}),
		  .io({tmpIO_0__SPIM_MISO_net[0:0]}),
		  .siovref(tmpSIOVREF__SPIM_MISO_net),
		  .interrupt({tmpINTERRUPT_0__SPIM_MISO_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SPIM_MISO_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("d4869237-3ca0-4d75-a1ec-bcd54980244a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
